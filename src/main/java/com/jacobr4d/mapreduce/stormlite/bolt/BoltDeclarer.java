...
import com.jacobr4d.mapreduce.stormlite.routers.Broadcast;
import com.jacobr4d.mapreduce.stormlite.routers.FieldBased;
import com.jacobr4d.mapreduce.stormlite.routers.First;
import com.jacobr4d.mapreduce.stormlite.routers.RoundRobin;
...
public class BoltDeclarer implements Serializable {
	...
	public void setUpstreamName(String s) {
		stream = s;
	}
